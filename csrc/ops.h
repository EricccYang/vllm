...
torch::Tensor fused_qk_norm_rope_cache_quant_v2(
    torch::Tensor query, torch::Tensor key, torch::Tensor value,
    torch::Tensor k_cache, torch::Tensor v_cache, torch::Tensor q_weight,
    torch::Tensor k_weight, torch::Tensor cos_sin_cache,
    torch::Tensor positions, torch::Tensor slot_mapping, double k_scale,
    double v_scale, double epsilon, int64_t num_heads_q,
    int64_t num_heads_kv, int64_t head_dim, int64_t block_size, bool is_neox,
    bool is_fp8);
